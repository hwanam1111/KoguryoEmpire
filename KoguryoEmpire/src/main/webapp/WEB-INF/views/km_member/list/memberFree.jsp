...
<html>
	<head>
		...
		<link href="${pageContext.request.contextPath}/resources/css/km_member/list/memberFree.css" rel="stylesheet" type="text/css">
	...
	<body>
		...
		<div class="container">
			<table class="table table-bordered">
				...
				<tr>
					<td>1</td>
					<td><a href="km_freeView.do">Free Title Test</a></td>
					<td>KoguryoGuild</td>
