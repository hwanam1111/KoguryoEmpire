...
<html>
	<head>
		...
		<link href="${pageContext.request.contextPath}/resources/css/km_member/list/attackPhoto.css" rel="stylesheet" type="text/css">
	...
	<body>
		...
		<div class="container">
			<table class="table table-bordered">
				...
				<tr>
					<td>1</td>
					<td><a href="km_atPhotoView.do">Time Atack Photo Title Test</a></td>
					<td>KoguryoGuild</td>
			...
			<a href="km_atPhotoWrite.do"><button class="btn">글쓰기</button></a>
		</div>
	</body>
</html> 