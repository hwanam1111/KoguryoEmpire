...
<html>
	...
	<body>
		...
		<%} %>
		<div id="content">
			<form id="km_noticeUpdateFormOk"> <!--  onsubmit="alert('Your submitted HTML was:\n\n' + document.getElementById('noise').value); return false;" -->
				<div class="form-group">
					<input type="text" class="form-control" id="noticeTitle" name="noticeTitle" placeholder="제목 입력" value="${noticeUpdateForm.noticeTitle}">
				</div>
