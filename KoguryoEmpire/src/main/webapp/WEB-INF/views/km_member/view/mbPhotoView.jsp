...
<html>
	<head>
		...
		<link href="${pageContext.request.contextPath}/resources/css/km_member/view/mbPhotoView.css" rel="stylesheet" type="text/css">
			...
			<div class="reply">
				...
				<form>
					<div class="form-group">
						<input type="text" class="form-control" id="mbphotoReply" name="mbphotoReply" placeholder="댓글 입력">
